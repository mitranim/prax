 ...
 *
 *
 * A _fiend_ takes arbitrary arguments and returns a transducer. We use
 * fiends to share the same input and output functions between all
 * factors (`atom.read` and `send`, or mocks in unit tests).
 *
 ...
 * push-based rather than pull-based concurrency, `send` explicitly doesn't
 * return a value.
 */
