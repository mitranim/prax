...
// Takes a view class, such as React.Component, and an instance of WatchNow
// referencing a prax app. Returns a function that creates a subclass of this
// view from a vanilla JavaScript function. The resulting view is reactive: if
// the function accesses the app data, the view will automatically update when
...
// Creates a function that takes a React class and subsclasses it, creating a
// view that is reactive relative to the given watch function. See examples in
// docs.
...
function ReactiveRender (watch) {
  ...
  return function reactiveRender (Component) {
    ...
    Reactive.prototype = Object.create(Component.prototype, descriptors({
      ...
      // Prevent unnecessary renders caused by ancestor views. This works best
...
function descriptors (values) {
  const out = {}
  for (const key in values) out[key] = {value: values[key]}
  return out
}
