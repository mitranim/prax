...
const {slice, validate, mapVals, isFunction} = require('fpx')
...
//   const reactiveRender = ReactiveRender(watchNow)
...
function descriptors (values) {
  return mapVals(descriptor, values)
}
