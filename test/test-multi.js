...
const main = pt.join(__dirname, '../lib/prax-multi.js')
...
// This source is created with one copy of prax, and should work with another.
source = new Source(first)

// Re-interpret the library from disk.
if (!require.cache[main]) throw Error()
delete require.cache[main]
const secondAutorun = require(main).autorun

// Make sure we really got a new copy.
if (secondAutorun === autorun) throw Error()
