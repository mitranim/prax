...
function scheduleUpdate () {
  // Safeguard against forgotten `super.componentWillUnmount()` calls. Won't
  // eliminate accidental leaks, but should reduce them.
  if (!isActiveInstance(this)) {
    PraxComponent.prototype.componentWillUnmount.call(this)
    return
  }
