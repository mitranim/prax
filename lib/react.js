...
const methods = {
  ...
  componentWillUnmount () {
    ...
    if (this._willUnmount) this._willUnmount(...arguments)
  },
...
function reactiveCreateClass (createClass, env, context) {
  ...
  return function createReactiveClass (config) {
    return createClass({
      ...
      _willUnmount: config.componentWillUnmount,
