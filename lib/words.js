...
const {bind, pipe, defer, spread, slice, indexOf, ifonly, test, and, or, not, id,
...
const isMutable = and(or(isObject, isFunction), not(Object.isFrozen))
