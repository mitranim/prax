...
function createAuto (Component, watch) {
  ...
  return function auto (renderFunc) {
    ...
    Auto.prototype = Object.create(Component.prototype, propertyDescriptors({
      constructor: Auto,
      ...
      _render (read) {
        this._dom = renderFunc(this.props, read)
      },
...
function createReactiveRender (watch) {
  ...
  return function reactiveRender (Component) {
    ...
    Reactive.prototype = Object.create(Component.prototype, propertyDescriptors({
...
function propertyDescriptors (values) {
  const buffer = {}
