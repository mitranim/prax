...
Replaces `React.createElement`. Usage:
  ...
  export function E(...args) {return x.R(x.E, ...args)}
  export function S(...args) {return x.R(x.S, ...args)}
*/
...
/*
Replaces `React.Fragment`. Usage:

  import * as x from 'prax'
  function E(...args) {return x.R(x.E, ...args)}
  E(x.F, null, a, b, c)

The calls should be auto-generated by a JSX/TSX transpiler.
*/
